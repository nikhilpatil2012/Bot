...
public class DBManager {
    ...
    public enum CollectionList  {
         ...
         Users, Selfies, Images, ImagesUnderReview
    }

    // Open connection to the remote database
    private void openConnection(){

        MongoCredential credential = MongoCredential.createCredential("nick_db", "save_a_selfie", "99111".toCharArray());
        MongoClient client = new MongoClient(new ServerAddress("ds055885.mongolab.com", 55885), Arrays.asList(credential));
        client.setWriteConcern(WriteConcern.ACKNOWLEDGED);
        databaseConnection = client.getDatabase("save_a_selfie");
    }
   ...
   */
    ...
    public FindIterable<Document> getDocumentById(CollectionList collectionName, String id){
